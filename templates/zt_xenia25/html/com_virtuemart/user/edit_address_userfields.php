 ...
 * @version $Id: edit_address_userfields.php 6142 2012-06-20 15:58:22Z alatak $
 */
...
*/
	...
	if (($typefield == 'corefield' && (in_array($_field['name'], $corefields) /**/ && $_field['name'] != 'agreed') )
		or ($typefield == 'billto' && !(in_array($_field['name'], $corefields) /**/ && $_field['name'] != 'agreed') )) {
	    if (!$_table) {
	    ...
	    echo '					' . $_field['title'] . ($_field['required'] ? "<span class='star'> *</span>" : '') . "\n";
	    echo '				</label>' . "\n";
	    echo '			</td>' . "\n";
	    echo '			<td>' . "\n";
