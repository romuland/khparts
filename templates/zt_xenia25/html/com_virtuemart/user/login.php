...
<?php   }
	...
	<div>
		<div id="title-text" style="font-size:120%"><?php echo JText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></div>
	</div>
<div class="clear"></div>
<?php } else { ?>
...
<?php }   ?>
        ...
        <p class="width30 floatleft" id="com-form-login-remember">
            ...
            <label for="remember" style="color:#09F; text-decoration:underline;" onclick="function(){document.getElementByID('remember').value='yes'}"><?php echo $remember_me = JVM_VERSION===1? JText::_('Remember me') : JText::_('JGLOBAL_REMEMBER_ME') ?></label>
            <?php endif; ?>
        </p>
        <div class="clr"></div>
...
<?php  }else if ($user->id  ){ 
/*Приветсвие и Кнопка выйти - удаляем*/
/*
