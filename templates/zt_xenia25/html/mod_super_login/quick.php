	...
	<span class="super-login">
      ...
      <span class="logout">
			...
			<?php endif; ?>
			 ...
			 <span class="account">
            	<a href="<?php echo JRoute::_( 'index.php?option=com_virtuemart&view=user&layout=edit' ); ?>" title="<?php echo "Личный кабинет"; ?>"></a>
        	 </span>
      ...
      <table><tr><td>
            ...
            <tr><td id="top-right">
 				<div><jdoc:include type="modules" name="top-right" /></div>
			</td></tr></table>
