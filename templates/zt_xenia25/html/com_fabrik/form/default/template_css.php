...
.fabrikForm{	
	...
	box-shadow: 0px 5px 18px #CCC;
 	...
 	-khtml-box-shadow:0px 5px 18px #CCC;
...
.fabrikElementContainer input[type='radio']{
	
}


.fabrikElementContainer li{
	background:none;
}
...
.fabrikElementContainer img.fabrikTip{
	padding: 0px;
	}	
.fabrikElement ul{
	margin: 0px;
