...
class JElementColor extends JElement {
	...
	function fetchElement($name, $value, &$node, $control_name) {
		ob_start();
		$img=JUri::root()."modules/mod_AutsonSlideShow/images/rainbow.png";
		$imgx=JUri::root()."modules/mod_AutsonSlideShow/images/";
		static $embedded;
		if(!$embedded) {
			$css2=JUri::root()."modules/mod_AutsonSlideShow/css/mooRainbow.css";
			$jspath=JUri::root()."modules/mod_AutsonSlideShow/js/mooRainbow.js";
?>
