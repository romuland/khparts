<?php
/**------------------------------------------------------------------------
# plg_socbuttons - Social Share Buttons Plugin Content for Joomla 1.6 - Joomla 1.7
# author    tallib
...
-------------------------------------------------------------------------**/
/**------------------------------------------------------------------------
* file: socbuttons.php 1.4.0, October 2011 20:00:00 RcReated $
...
class plgContentSocButtons extends JPlugin 
{
	...
	{	
		if($context == 'com_content.article'){
			...
			$html .= '<div class="socbuttons" style="padding-top: 20px; overflow: hidden; float: '.$this->params->get('fb_align', 'left').';">';
            ...
            $doc->addCustomTag( '<link rel="image_src" href="'.$matches[1].'" />' );
				...
				$html .= '<a target="_blank" class="mrc__plugin_uber_like_button" href="http://connect.mail.ru/share?share_url='.$link.'" data-mrc-config="{ \'type\' : \''.$this->params->get('Odnomm_type').'\', \'caption-mm\' : \''.$this->params->get('mm_txt').'\', \'caption-ok\' : \''.$this->params->get('odn_txt').'\', \'width\' : \'100%\', \'nc\' : \''.$this->params->get('Odnomm_cotr').'\', \'nt\' : \'1\'}">Нравится</a>';
			...
			$html .= '<div class="'.$soc_copr.'"><a href="http://nauca.com.ua/plugins/socbuttons-v14/" title="SocButtons v1.4" target="_blank">SocButtons v1.4</a></div>';
			$html .= '</div>';
			$html .= '<div style="clear:both;"></div>';
			//end plugin
